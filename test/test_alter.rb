...
class TestAlter < Test::Unit::TestCase
  ...
  def test_append_to_element_with_content
    document = Hpricot.parse("<html><head></meta></head><body><p>Hi!@!!</p><div id='location_9'></div></body></html>")
    document.search('body').append('<div id="append"></div>')
    assert_equal '<html><head></head><body><p>Hi!@!!</p><div id="location_9"></div><div id="append"></div></body></html>', document.html
  end

  def test_append_to_empty_element
    document = Hpricot.parse("<html><head></meta></head><body></body></html>")
    document.search('body').append('<div id="append"></div>')
    assert_equal '<html><head></head><body><div id="append"></div></body></html>', document.html
  end

  def test_prepend_to_element_with_content
    document = Hpricot.parse("<html><head></meta></head><body><p>Hi!@!!</p><div id='location_9'></div></body></html>")
    document.search('body').prepend('<div id="prepend"></div>')
    assert_equal '<html><head></head><body><div id="prepend"></div><p>Hi!@!!</p><div id="location_9"></div></body></html>', document.html
  end

  def test_prepend_to_empty_element
    document = Hpricot.parse("<html><head></meta></head><body></body></html>")
    document.search('body').prepend('<div id="prepend"></div>')
    assert_equal '<html><head></head><body><div id="prepend"></div></body></html>', document.html
  end
